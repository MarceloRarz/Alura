...
namespace bytebank_ATENDIMENTO.bytebank.Atendimento
{
    ...
    public class ByteBankAtendimento
    {
        ...
        public List<ContaCorrente> _listaDeContas = new List<ContaCorrente>(){
        ...
        private void ExportarContasXML()
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    FileStream fs = new FileStream($@"{path}\contas.xml", FileMode.Create);
                  //  var contasXML = new XmlSerializer(typeof(List<ContaCorrente>));
                    ...
                    serializador.Serialize(fs, _listaDeContas);
